...
public class Zadatak3 {
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            driver.findElement(By.name("name")).sendKeys("Nikola Nikolic");
            driver.findElement(By.name("department")).sendKeys("QA Automation");
            driver.findElement(By.name("phone")).sendKeys("+38181818181");
